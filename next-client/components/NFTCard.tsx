...
interface NFTCardStyles {
  key?: string;
  nft?: any;
}

const NFTCard = ({ key, nft }: NFTCardStyles) => {
  return (
    <Link href={{ pathname: "/nft-details", query: nft }}>
      ...
      >
        ...
        <div className="mt-3 flex flex-col">
          ...
          <div className="flexBetween mt-1 minlg:mt-3 xs:flex-col xs:items-start xs:mt-3">
            <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xs minlg:text-lg">{nft.price} <span className="normal">ADA</span></p>
